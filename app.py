...
if page == "Homepage":
    ...
    st.image("https://cdn.onemars.net/sites/dreamies_th_r81SA_r9CA/image/aging_1694526227488.jpeg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
...
# Contact Us
    ...
    st.write("- Email: 33482@tepleela.ac.th")
